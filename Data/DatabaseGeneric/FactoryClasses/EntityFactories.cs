...
namespace EmployeeManagment.FactoryClasses
{
	...
	{
		private readonly EmployeeManagment.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, EmployeeManagment.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((EmployeeManagment.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public EmployeeEntityFactory() : base("EmployeeEntity", EmployeeManagment.EntityType.EmployeeEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(EmployeeManagment.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(EmployeeManagment.EntityType)))
			{
				var factory = GetFactory((EmployeeManagment.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the EmployeeManagment.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(EmployeeManagment.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
	...
	{
		/// <summary>Gets the factory of the Entity type with the EmployeeManagment.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (EmployeeManagment.EntityType)Enum.Parse(typeof(EmployeeManagment.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((EmployeeManagment.EntityType)Enum.Parse(typeof(EmployeeManagment.EntityType), leftOperandEntityName, false), joinType, (EmployeeManagment.EntityType)Enum.Parse(typeof(EmployeeManagment.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (EmployeeManagment.EntityType)Enum.Parse(typeof(EmployeeManagment.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((EmployeeManagment.EntityType)entityTypeValue); }
